...
export const mockBacktests: Backtest[] = [
  {
    ...
    strategy_params_snapshot: { fast: 21, slow: 55, atr: 14 },
    final_capital: 18450,
    total_return: 84.5,
    cagr: 23.3,
    sharpe_ratio: 1.84,
  ...
  },
  {
    ...
    fee_rate: 0.001,
    slippage_rate: 0.0005,
    strategy_params_snapshot: { rsiPeriod: 14, oversold: 28, overbought: 72 },
    final_capital: 15100,
    total_return: 51,
    cagr: 15.1,
    sharpe_ratio: 1.21,
...
export const mockWalkforward: WalkforwardResult[] = [
  {
    ...
    strategy_id: "s1",
    run_group_id: "wg1",
    run_start_date: "2023-01-01",
    run_end_date: "2025-12-31",
    initial_capital: 10000,
    fee_rate: 0.001,
    slippage_rate: 0.0005,
    windows_requested: 2,
